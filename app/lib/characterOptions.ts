...
export const PROFESSIONS = [
  ...
  { id: "blacksmith", name: "Blacksmith", category: "CraftWeapon", description: "Hammer, anvil, fire. Iron and steel know your hands. Creation through force." },
  { id: "armorer", name: "Armorer", category: "CraftArmor", description: "Armor and blades. Protection and precision. Your work saves lives." },
  { id: "tinsmith", name: "Tinsmith", category: "CraftTool", description: "Cups, pots, pans. Useful beauty. Common things, well-made." },
  ...
  { id: "carpenter", name: "Carpenter", category: "CraftFurniture", description: "Lumberjack builds roofs, ships and houses. You built the bones of the world." },
...
export const PROFESSION_RESOURCE_FAMILIES: Record<string, string[]> = {
  ...
  CraftWeapon: ["ore", "wood", "sand"],
  CraftArmor: ["ore", "wood", "sand"],
  CraftTool: ["ore", "wood", "sand"],
  CraftStone: ["clay", "stone", "crystal"],
  CraftGarment: ["skin", "fiber", "herbs"],
  CraftGlass: ["sand", "crystal", "ore"],
  CraftFurniture: ["wood", "hide", "bone"],
