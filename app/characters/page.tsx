...
const PROFESSIONS = [
  ...
  { id: "fisherman", name: "Fisherman", category: "Rural", description: "Rivers and waters. Silent work, hard reward. You read currents." },
  ...
  { id: "leatherworker", name: "Leatherworker", category: "Craftsman — Leather", description: "Hides and dyes. Armor and saddles. Your craft is both practical and beautiful." },
  { id: "tanner", name: "Tanner", category: "Craftsman — Leather", description: "Raw hides into leather. Smells nobody forgets. Essential work, little glory." },
  { id: "weaver", name: "Weaver", category: "Craftsman — Fabric", description: "Loom and thread. Cloth and tapestry. Patterns from chaos." },
  { id: "dyer", name: "Dyer", category: "Craftsman — Fabric", description: "Colors from plants and minerals. Bringing life to cloth. Chemistry is your art." },
  ...
  { id: "fireperformer", name: "Fire Performer", category: "Craftsman — Glass", description: "Flame and skill. You spin fire, eat fire, dance with fire. The crowd holds its breath when you perform." },
  { id: "carpenter", name: "Carpenter", category: "Craftsman — Wood", description: "Wood and tools. Boats, houses, furniture. You built the bones of the world." },
  { id: "cooper", name: "Cooper", category: "Craftsman — Wood", description: "Barrels and casks. Wooden vessels. Small precision, great demand." },
  { id: "jeweler", name: "Jeweler", category: "Artisan", description: "Gems and precious metals. Tiny, intricate, priceless. Luxury is your medium." },
  { id: "potter", name: "Potter", category: "Artisan", description: "Clay and wheel. Vessels and art. Hands and water and earth." },
  ...
  { id: "innkeeper", name: "Innkeeper", category: "Trade", description: "Tavern and lodging. Stories and service. You know secrets." },
