    ...
    <div className={styles.page}>
      <section className={styles.guidelines}>
        ...
        <p className={styles.body}>
          In the Wudlands players explore a rich, modular world filled with dark forests, crumbling dungeons, and desperate choices, where every decision shapes their character&apos;s story and legacy.
        </p>
        ...
        <p className={styles.body}>
          It is a browser-based fantasy RPG that combines the narrative depth of classic Fighting Fantasy-style adventures with the on-chain character progression of modern blockchain gaming. Inspiration is drawn from the old-school choice-based <Link href="https://www.fightingfantasy.com/" target="_blank" rel="noopener noreferrer" className={styles.externalLink}>Fighting Fantasy</Link> format, <Link href="https://boardgamegeek.com/boardgame/199723/ultraquest-gold-ruhm-und-ehre" target="_blank" rel="noopener noreferrer" className={styles.externalLink}>UltraQuest</Link>,{" "}
